...
public class UserInfoRegistration extends AppCompatActivity {
    ...
    TextInputLayout regName,regEmail, regAge, regHeight, regWeight, regSickness;
    Button regBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        regSickness = findViewById(R.id.user_sickness);
        ...
        regBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String sickness = regSickness.getEditText().getText().toString();
